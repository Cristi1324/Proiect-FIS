...
public class PanelDate extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        cell40.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell41 = new main.Cell();
        cell41.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell42 = new main.Cell();
        cell42.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell43 = new main.Cell();
        cell43.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell44 = new main.Cell();
        cell44.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell45 = new main.Cell();
        cell45.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell46 = new main.Cell();
        cell46.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell47 = new main.Cell();
        cell47.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell48 = new main.Cell();
        cell48.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
        cell49 = new main.Cell();
        cell49.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        	}
        });
